...
### Optional tunables
   <table>
      ...
      <tr>
        ...
        <td> It is mutually exclusive with the <code>TARGET_NODE</code> environment variable. If both are provided, the fault uses <code>TARGET_NODE</code>. </td>
      </tr>
      <tr>
        <td> TOTAL_CHAOS_DURATION </td>
        <td> Duration for which to insert chaos (in seconds).</td>
        <td> Default: 15 s. Overall run duration of the fault may exceed the <code>TOTAL_CHAOS_DURATION</code> by a few minutes. </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td> Default: false. Supports true and false. </td>
      </tr>
      <tr>
        <td> FORCE </td>
        ...
        <td> Default: <code>true</code>, with <code>terminationGracePeriodSeconds=0</code>.  </td>
      </tr>
      <tr>
        <td> TARGET_PODS </td>
      ...
      <tr>
        ...
        <td> Default: 0 (corresponds to 1 replica). </td>
      </tr>
      <tr>
        <td> RAMP_TIME </td>
      ...
      <tr>
        ...
        <td> Default: parallel. Supports serial as well. </td>
      </tr>
    </table>
